...
## Data availability
In order to find appropriate answers for our research questions, we choose "NYPD Complaint Data Current(Year To Date)" dataset from NYCOpenData website as our main data source to analyze. 
