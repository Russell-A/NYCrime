...
p_occurence <- ggplot(df_occur_count, mapping = aes(x = Date, y = Frequency)) + geom_path()+ geom_point() + xlab("Date") + ylab("Frequency") + ggtitle("Frequency of Crime in 2022")
...
p <- ggplot(df_law_22, mapping = aes(x = Date, y = n, group = `Law Category`, color = `Law Category`))  + geom_line() +geom_point()+labs(x = "Date", y = "Frequency", title = "Frequency of Crime in Different Law Categories in 2022", color = "Law Category")
ggplotly(p)
```
...
colnames(df_law_22) <- c("Law Category", "Hour", "n")
 p <- ggplot(df_law_22, mapping = aes(x = Hour, y = n, group = `Law Category`, color = `Law Category`)) + geom_line()+geom_point() +labs(x = "Hour", y = "Frequency", title = "Frequency of Crimes in Different Law Categories in Different Time of a Day in 2022", color = "Law Category")
 ggplotly(p)
```
...
### Borough Analysis
```{r Borough_2022, message=FALSE, fig.width=10}
